...
let  listaDefrutas = ['bergamota','uva','maçã']
...
print("devo levar um guarda chuva"(frio))

let idadepessoa = 15;
let idadepermitida = 18;
let resultado1 =  idadedapessoa >= idadepermitida
console.log(resultado)
...
// 17. Crie um array de números e filtre os números maiores que 10.
